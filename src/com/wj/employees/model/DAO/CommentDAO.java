...
public class CommentDAO {
	...
	// �Խñ� ��ȣ �������� �Լ�
		...
		public int write(int asno, String content) {
			Connection conn = null;
			PreparedStatement pstmt = null;

			try {
				conn = ConnUtil.getConnection();
				pstmt = conn.prepareStatement("INSERT INTO COMMENTAS VALUES(?, ?, 'admin', null, sysdate, ?)");
		...
		public int write2(int i, int parent, String content) {
			Connection conn = null;
			PreparedStatement pstmt = null;
